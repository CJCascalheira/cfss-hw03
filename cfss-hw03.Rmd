...
Again, we can use our data frame of the sum of cases per term as the denominator of the ratio. First, we need to calculate the number of cases decided in the conservative direction. 
